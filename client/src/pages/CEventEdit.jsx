        ...
        <tbody>
          {events.map((event) => (
            ...
            >
              ...
              <td className="px-6 py-4">{event.minidescription}</td>
              <td className="px-6 py-4 w-12">
                <div className="truncate">{event.description}</div>
              </td>
              <td className="px-6 py-4">{event.volunteerLink}</td>
              <td className="px-6 py-4">{event.participateLink}</td>
          ...
          <div className="bg-white p-6 dark:bg-gray-800 dark:text-white w-full sm:w-96 overflow-y-auto max-h-full">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700 mr-2"
                >
                  Save
                </button>
                <button
