        ...
        <div className="relative">
            <div className="relative z-0 mt-14" style={getHeightStyle()}>{/* Set a lower z-index for the carousel */}
                <Carousel slideInterval={5000} theme={{
                    ...
                    <img src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/emotion.png
" alt="..." style={{ width: '100%', height: '100%' }} />
                    <img src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/spandana.png
" alt="..." style={{ width: '100%', height: '100%' }} />
                    <img src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/safe.png
" alt="..." style={{ width: '100%', height: '100%' }} />
                </Carousel>
            </div>
            <section class="bg-white dark:bg-gray-900">
                <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div class="mr-auto place-self-center lg:col-span-7">
                        <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-5xl dark:text-white">Welcome to TechChapters !</h1>
                        <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">This is TechChapters where you can find all the technological clubs and societies of Sri Lanka under one roof! Explore the vibrant tapestry of Sri Lankan clubs and societies – where passions unite, talents flourish, and a myriad of events unfold.</p>
                    ...
                    <div class="mt-3 lg:mt-0 lg:col-span-5 lg:flex">
                        <img src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/music.jpg
" alt="mockup" class="rounded-2xl shadow-lg" />
                    </div>
            ...
            <div class="flex flex-col items-center md:flex-row justify-center mx-auto mt-8">
                <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 md:mb-0">
                    <a href="#">
                        <img class="rounded-t-lg" src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/foc.jpg" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="/clubs">
                ...
                <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
                    <a href="/FOB">
                        <img class="rounded-t-lg" src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/fob1.jpg
" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="/FOB">
                ...
                <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
                    <a href="/FOE">
                        <img class="rounded-t-lg" src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/engi.jpg
" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="/FOE">
                ...
                <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
                    <a href="/FOS">
                        <img class="rounded-t-lg" src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/fos.jpg
" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="/FOS">
            ...
            <div class="flex flex-col items-center md:flex-row justify-center mx-auto mt-12">
                <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 md:mb-0">
                    <a href="/international">
                        <img class="rounded-t-lg" src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/aie.jpg
" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="/international">
                ...
                <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
                    <a href="/Religous">
                        <img class="rounded-t-lg" src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/bud.jpg
" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="/Religous">
                ...
                <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
                    <a href="/activitybased">
                        <img class="rounded-t-lg" src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/act.jpg" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="/activitybased">
                ...
                <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
                    <a href="/careerguidance">
                        <img class="rounded-t-lg" src="https://raw.githubusercontent.com/NChapters-Project/NChapters/master/client/src/images/career.webp
" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="/careerguidance">
