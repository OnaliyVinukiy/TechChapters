...
import img1 from "../images/sample/5.jpg";
import img2 from "../images/sample/7.jpg";
import img3 from "../images/sample/8.jpg";
import nsbmImg from "../images/nsbm2.jpg";

import colomboImg from "../images/campus/colombo.jpg";
import kelaniyaImg from "../images/campus/kelaniya.png";
import moratuwaImg from "../images/campus/moratuwa.png";
import ruhunaImg from "../images/campus/ruhuna.png";
import jayawardanapuraImg from "../images/campus/jayawardanapura.jpg";
...
"
        ...
        <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
          <a href="/FOE">
            <img className="rounded-t-lg mt-5" src={nsbmImg} alt="" />
          </a>
          <div class="p-5">
            <a href="/FOE">
              <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">
        ...
        <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
          <a href="/FOS">
            <img className="rounded-t-lg mt-10" src={colomboImg} alt="" />
          </a>
          <div class="p-5">
            <a href="/FOS">
              <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">
      ...
      <div class="flex flex-col items-center md:flex-row justify-center mx-auto mt-12">
        <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 md:mb-0">
          <a href="/international">
            <img
              className="rounded-t-lg h-40 pl-10 mt-5"
              src={kelaniyaImg}
              alt=""
            />
          </a>
        ...
        <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
          <a href="/activitybased">
            <img
              className="rounded-t-lg h-50 pl-10 mt-10"
              src={ruhunaImg}
              alt=""
            />
          </a>
        ...
        <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
          <a href="/careerguidance">
            <img
              className="rounded-t-lg h-40 pl-10"
              src={jayawardanapuraImg}
              alt=""
            />
          </a>
          <div class="p-5">
      ...
      <div class="flex items-center justify-center mt-10 bg-white dark:bg-gray-900">
  <a
    href="/FOB"
    class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
  >
